...
namespace colturi
{
    public partial class Form1 : Form
    {
        ...
        private void button_click(object sender, EventArgs e)//schimba culorile stickerelor
        {
        ...
        void InitMat()
        {
            //----------------------------------------------Colturi----------------------------------------------------------
            //1
            matColturi[1, 0] = button27;//atribui butonul corespunzător stickerului
        ...
        int ConvertCuloare(Button b)
        {
            ...
            if (b.BackColor == Color.Lime) return 5;//Lime se refera la Verde
            if (b.BackColor == Color.Blue) return 6;
            MessageBox.Show("Eroare in ConvertCuloare()!");//Pentru siguranta
            return 7;
        }
        ...
        int ReturnHome(Colt c)
        {
            ...
            if (Compara(aux, c))///8
                return 8;
            MessageBox.Show("Eroare. Nu gasesc home-ul coltului.");
            return 9;
        ...
        Color ConvertStringToCuloare(string cul)
        {
            if(cul=="alb")
                return Color.White;
            if (cul == "galben")
            ...
            MessageBox.Show("Eroare in ConvertStringToCuloare");
            return Color.Lime;
        }

        void ColorezaStickereConformDetectiei(string cul1, string cul2, string cul3, string cul4, string cul5, string cul6, string cul7, string cul8, string cul9)
        {
            if (cul5 == "verde")//front
            {
                //button1.BackColor = ConvertStringToCuloare(cul1);
                //in loc de linia de mai sus, scriu: 
                

                culoare = ConvertStringToCuloare(cul1);//temporar, cat sa apelez functia
                button_click(button1, null);

                //button2.BackColor = ConvertStringToCuloare(cul2);
                culoare = ConvertStringToCuloare(cul2);
                button_click(button2, null);

                //button3.BackColor = ConvertStringToCuloare(cul3);
                culoare = ConvertStringToCuloare(cul3);
                button_click(button3, null);

                ///button4.BackColor = ConvertStringToCuloare(cul4);
                culoare = ConvertStringToCuloare(cul4);
                button_click(button4, null);

                //button5.BackColor = ConvertStringToCuloare(cul5);
                culoare = ConvertStringToCuloare(cul5);
                button_click(button5, null);

                //button6.BackColor = ConvertStringToCuloare(cul6);
                culoare = ConvertStringToCuloare(cul6);
                button_click(button6, null);

                //button7.BackColor = ConvertStringToCuloare(cul7);
                culoare = ConvertStringToCuloare(cul7);
                button_click(button7, null);

                //button8.BackColor = ConvertStringToCuloare(cul8);
                culoare = ConvertStringToCuloare(cul8);
                button_click(button8, null);

                //button9.BackColor = ConvertStringToCuloare(cul9);
                culoare = ConvertStringToCuloare(cul9);
                button_click(button9, null);
            }

            if (cul5 == "rosu")//right
            {
                //button18.BackColor = ConvertStringToCuloare(cul1);
                culoare = ConvertStringToCuloare(cul1);
                button_click(button18, null);

                //button17.BackColor = ConvertStringToCuloare(cul2);
                culoare = ConvertStringToCuloare(cul2);
                button_click(button17, null);

                //button16.BackColor = ConvertStringToCuloare(cul3);
                culoare = ConvertStringToCuloare(cul3);
                button_click(button16, null);

                //button15.BackColor = ConvertStringToCuloare(cul4);
                culoare = ConvertStringToCuloare(cul4);
                button_click(button15, null);

                //button14.BackColor = ConvertStringToCuloare(cul5);
                culoare = ConvertStringToCuloare(cul5);
                button_click(button4, null);

                //button13.BackColor = ConvertStringToCuloare(cul6);
                culoare = ConvertStringToCuloare(cul6);
                button_click(button13, null);

                //button12.BackColor = ConvertStringToCuloare(cul7);
                culoare = ConvertStringToCuloare(cul7);
                button_click(button12, null);

                //button11.BackColor = ConvertStringToCuloare(cul8);
                culoare = ConvertStringToCuloare(cul8);
                button_click(button11, null);

                //button10.BackColor = ConvertStringToCuloare(cul9);
                culoare = ConvertStringToCuloare(cul9);
                button_click(button10, null);
            }

            if (cul5 == "albastru")//back
            {
                //button36.BackColor = ConvertStringToCuloare(cul1);
                culoare = ConvertStringToCuloare(cul1);
                button_click(button36, null);

                //button35.BackColor = ConvertStringToCuloare(cul2);
                culoare = ConvertStringToCuloare(cul2);
                button_click(button35, null);

                //button34.BackColor = ConvertStringToCuloare(cul3);
                culoare = ConvertStringToCuloare(cul3);
                button_click(button34, null);

                //button33.BackColor = ConvertStringToCuloare(cul4);
                culoare = ConvertStringToCuloare(cul4);
                button_click(button33, null);

                //button32.BackColor = ConvertStringToCuloare(cul5);
                culoare = ConvertStringToCuloare(cul5);
                button_click(button32, null);

                //button31.BackColor = ConvertStringToCuloare(cul6);
                culoare = ConvertStringToCuloare(cul6);
                button_click(button31, null);

                //button30.BackColor = ConvertStringToCuloare(cul7);
                culoare = ConvertStringToCuloare(cul7);
                button_click(button30, null);

                //button29.BackColor = ConvertStringToCuloare(cul8);
                culoare = ConvertStringToCuloare(cul8);
                button_click(button29, null);

                //button28.BackColor = ConvertStringToCuloare(cul9);
                culoare = ConvertStringToCuloare(cul9);
                button_click(button28, null);
            }

            if (cul5 == "portocaliu")//left
            {
                //button54.BackColor = ConvertStringToCuloare(cul1);
                culoare = ConvertStringToCuloare(cul1);
                button_click(button54, null);

                //button53.BackColor = ConvertStringToCuloare(cul2);
                culoare = ConvertStringToCuloare(cul2);
                button_click(button53, null);

                //button52.BackColor = ConvertStringToCuloare(cul3);
                culoare = ConvertStringToCuloare(cul3);
                button_click(button52, null);

                //button51.BackColor = ConvertStringToCuloare(cul4);
                culoare = ConvertStringToCuloare(cul4);
                button_click(button51, null);

                //button50.BackColor = ConvertStringToCuloare(cul5);
                culoare = ConvertStringToCuloare(cul5);
                button_click(button50, null);

                //button49.BackColor = ConvertStringToCuloare(cul6);
                culoare = ConvertStringToCuloare(cul6);
                button_click(button49, null);

                //button48.BackColor = ConvertStringToCuloare(cul7);
                culoare = ConvertStringToCuloare(cul7);
                button_click(button48, null);

                //button47.BackColor = ConvertStringToCuloare(cul8);
                culoare = ConvertStringToCuloare(cul8);
                button_click(button47, null);

                //button46.BackColor = ConvertStringToCuloare(cul9);
                culoare = ConvertStringToCuloare(cul9);
                button_click(button46, null);
            }

            if (cul5 == "alb")//up
            {
                //button27.BackColor = ConvertStringToCuloare(cul1);
                culoare = ConvertStringToCuloare(cul1);
                button_click(button27, null);

                //button26.BackColor = ConvertStringToCuloare(cul2);
                culoare = ConvertStringToCuloare(cul2);
                button_click(button26, null);

                //button25.BackColor = ConvertStringToCuloare(cul3);
                culoare = ConvertStringToCuloare(cul3);
                button_click(button25, null);

                //button24.BackColor = ConvertStringToCuloare(cul4);
                culoare = ConvertStringToCuloare(cul4);
                button_click(button24, null);

                //button23.BackColor = ConvertStringToCuloare(cul5);
                culoare = ConvertStringToCuloare(cul5);
                button_click(button23, null);

                //button22.BackColor = ConvertStringToCuloare(cul6);
                culoare = ConvertStringToCuloare(cul6);
                button_click(button22, null);

                //button21.BackColor = ConvertStringToCuloare(cul7);
                culoare = ConvertStringToCuloare(cul7);
                button_click(button21, null);

                //button20.BackColor = ConvertStringToCuloare(cul8);
                culoare = ConvertStringToCuloare(cul8);
                button_click(button20, null);

                //button19.BackColor = ConvertStringToCuloare(cul9);
                culoare = ConvertStringToCuloare(cul9);
                button_click(button19, null);

            }

            if (cul5 == "galben")//galben
            {
                //button45.BackColor = ConvertStringToCuloare(cul1);
                culoare = ConvertStringToCuloare(cul1);
                button_click(button45, null);

                //button44.BackColor = ConvertStringToCuloare(cul2);
                culoare = ConvertStringToCuloare(cul2);
                button_click(button44, null);

                //button43.BackColor = ConvertStringToCuloare(cul3);
                culoare = ConvertStringToCuloare(cul3);
                button_click(button43, null);

                //button42.BackColor = ConvertStringToCuloare(cul4);
                culoare = ConvertStringToCuloare(cul4);
                button_click(button42, null);

                //button41.BackColor = ConvertStringToCuloare(cul5);
                culoare = ConvertStringToCuloare(cul5);
                button_click(button41, null);

                //button40.BackColor = ConvertStringToCuloare(cul6);
                culoare = ConvertStringToCuloare(cul6);
                button_click(button40, null);

                //button39.BackColor = ConvertStringToCuloare(cul7);
                culoare = ConvertStringToCuloare(cul7);
                button_click(button39, null);

                //button38.BackColor = ConvertStringToCuloare(cul8);
                culoare = ConvertStringToCuloare(cul8);
                button_click(button38, null);

                //button37.BackColor = ConvertStringToCuloare(cul9);
                culoare = ConvertStringToCuloare(cul9);
                button_click(button37, null);
            }
        }


        private void run_python_script(string cmd, string args)
        {
            ProcessStartInfo start = new ProcessStartInfo();
            start.FileName = "C:\\Users\\smito\\AppData\\Local\\Programs\\Python\\Python38-32\\python.exe";
            ...
            using (Process process = Process.Start(start))
            {
                using (StreamReader reader = process.StandardOutput)
                {
                    ...
                    Console.Write("Rezultatul transmis de scriptul de Python este: " + result + " \nacesta a fost rezultatul\n");
                    int i;
                    i = 0;
                    while (result[i] != '[')
                        i++;
                    i++;
                    //acum sunt la apostrof
                    char apostrof = result[i];


                    //____________________________________Culoarea 1___________________________________
                    string culoare1 = "";//initial sirul vid
                    i++;
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare1 = culoare1 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare1 = " + culoare1);
                    //acum sunt iar la apostrof
                    i++;//m-am dus pe virgula
                    i++;//m-am dus pe spatiu
                    i++;//apostrof din nou
                    i++;//inceputul noii culori
                    //acum sunt la prima litera din culoarea 2

                    //____________________________________Culoarea 2___________________________________

                    string culoare2 = "";//initial sirul vid
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare2 = culoare2 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare2 = " + culoare2);
                    //acum sunt iar la apostrof
                    i++;//m-am dus pe virgula
                    i++;//m-am dus pe spatiu
                    i++;//apostrof din nou
                    i++;//inceputul noii culori
                        //acum sunt la prima litera din culoarea 3


                    //____________________________________Culoarea 3___________________________________

                    string culoare3 = "";//initial sirul vid
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare3 = culoare3 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare3 = " + culoare3);
                    //acum sunt iar la apostrof
                    i++;//m-am dus pe virgula
                    i++;//m-am dus pe spatiu
                    i++;//apostrof din nou
                    i++;//inceputul noii culori
                        //acum sunt la prima litera din culoarea 4



                    //____________________________________Culoarea 4___________________________________

                    string culoare4 = "";//initial sirul vid
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare4 = culoare4 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare4 = " + culoare4);
                    //acum sunt iar la apostrof
                    i++;//m-am dus pe virgula
                    i++;//m-am dus pe spatiu
                    i++;//apostrof din nou
                    i++;//inceputul noii culori
                        //acum sunt la prima litera din culoarea 5



                    //____________________________________Culoarea 5___________________________________

                    string culoare5 = "";//initial sirul vid
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare5 = culoare5 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare5 = " + culoare5);
                    //acum sunt iar la apostrof
                    i++;//m-am dus pe virgula
                    i++;//m-am dus pe spatiu
                    i++;//apostrof din nou
                    i++;//inceputul noii culori
                        //acum sunt la prima litera din culoarea 6



                    //____________________________________Culoarea 6___________________________________

                    string culoare6 = "";//initial sirul vid
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare6 = culoare6 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare6 = " + culoare6);
                    //acum sunt iar la apostrof
                    i++;//m-am dus pe virgula
                    i++;//m-am dus pe spatiu
                    i++;//apostrof din nou
                    i++;//inceputul noii culori
                        //acum sunt la prima litera din culoarea 7

                    
                    
                    //____________________________________Culoarea 7___________________________________

                    string culoare7 = "";//initial sirul vid
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare7 = culoare7 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare7 = " + culoare7);
                    //acum sunt iar la apostrof
                    i++;//m-am dus pe virgula
                    i++;//m-am dus pe spatiu
                    i++;//apostrof din nou
                    i++;//inceputul noii culori
                        //acum sunt la prima litera din culoarea 8



                    //____________________________________Culoarea 8___________________________________

                    string culoare8 = "";//initial sirul vid
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare8 = culoare8 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare8 = " + culoare8);
                    //acum sunt iar la apostrof
                    i++;//m-am dus pe virgula
                    i++;//m-am dus pe spatiu
                    i++;//apostrof din nou
                    i++;//inceputul noii culori
                        //acum sunt la prima litera din culoarea 9


                    //____________________________________Culoarea 9___________________________________

                    string culoare9 = "";//initial sirul vid
                    //acum nu mai sunt la apostrof
                    while (result[i] != apostrof)
                    {
                        culoare9 = culoare9 + result[i];
                        i++;
                    }
                    Console.WriteLine("culoare9 = " + culoare9);

                    Console.Write("Acestea au fost cele 9 culori.");

                    ColorezaStickereConformDetectiei(
                        culoare1, culoare2, culoare3,
                        culoare4, culoare5, culoare6,
                        culoare7, culoare8, culoare9);
                }
            }
        }
        ...
        private void button60_Click(object sender, EventArgs e)
        {
            ...
            //D:\Licenta\Rubik - s - Cube - Solver\Rubik's Cube Solver in C#\colturi\colturi\bin\Debug

            string path_script_python = current_path + "\\..\\..\\..\\..\\..\\..\\tema5_cod+parametri\\cod\\RunProject.py";

            run_python_script("D:\\Licenta\\tema5_cod+parametri\\cod\\RunProject.py", "200");
            //run_python_script(path_script_python, "200");
        }
        ...
        private void buttonRezolva_Click(object sender, EventArgs e)
        {
            ...
            SolutieColturi = SolutieColturiSucite = SolutieMuchii = SolutieMuchiiSucite = "";
            {
                ...
                if (!PreaMult)
                {
                    InitMat();//initializarea matricei
                    FormezColturi();
                    FormezMuchii();
                    //Rubik.Mutarea_F();
                    PotRezolva = true;
